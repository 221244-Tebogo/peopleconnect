...
//         },
//       });
//       console.log("Employees fetched:", response.data); // Debugging output
//       setEmployees(response.data); // Set employees state with data
//     } catch (err) {
...
//   useEffect(() => {
//     fetchEmployees(); // Trigger fetch on component mount
//   }, []);

//   // Render loading, error, or employee table based on state
