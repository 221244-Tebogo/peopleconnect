...
import SidebarRight from "../../components/sidebar/SidebarRight"; // Import SidebarRight component
import "./HRTraining.css"; // Add CSS to manage layout
...
const HRTraining = () => {
  ...
  return (
    <div className="app-container">
      ...
      <SidebarRight /> {/* Add right sidebar for calendar and events */}
    </div>
  );
};
